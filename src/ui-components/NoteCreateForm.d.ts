...
export declare type NoteCreateFormValidationValues = {
    ...
    noteDescription?: ValidationFunction<string>;
    noteImage?: ValidationFunction<string>;
...
export declare type NoteCreateFormOverridesProps = {
    ...
    noteDescription?: PrimitiveOverrideProps<TextFieldProps>;
    noteImage?: PrimitiveOverrideProps<TextFieldProps>;
